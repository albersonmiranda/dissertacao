...
preds = lapply(c("xgb", "ranger", "glmnet", "lasso", "ridge", "svm", "lightgbm"), function(learner) {
  preds = readRDS(paste0("data/tourism/preds_ml/preds/", tipo, "/preds_", learner, "_fcv.RDS"))
...
# export
saveRDS(acuracia_ml, paste0("data/tourism/preds_ml/preds/", tipo, "/resumo_fcv.RDS"))