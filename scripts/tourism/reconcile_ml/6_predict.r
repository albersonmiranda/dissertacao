...
list(preds_xgb, xgb_time) |> saveRDS("data/tourism/preds_ml/preds/preds_xgb.RDS", compress = FALSE)
...
list(preds_ranger, ranger_time) |> saveRDS("data/tourism/preds_ml/preds/preds_ranger.RDS", compress = FALSE)
...
list(preds_glmnet, glmnet_time) |> saveRDS("data/tourism/preds_ml/preds/preds_glmnet.RDS", compress = FALSE)
...
list(preds_lasso, lasso_time) |> saveRDS("data/tourism/preds_ml/preds/preds_lasso.RDS", compress = FALSE)
...
list(preds_ridge, ridge_time) |> saveRDS("data/tourism/preds_ml/preds/preds_ridge.RDS", compress = FALSE)
