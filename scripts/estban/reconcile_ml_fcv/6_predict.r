...
source("scripts/estban/reconcile_ml_fcv/5_train_hp.r")
...
list(preds_xgb, xgb_time) |>
  saveRDS(paste0("data/estban/preds_ml/preds/", tipo, "/preds_xgb_fcv.RDS"), compress = FALSE)
...
list(preds_ranger, ranger_time) |>
  saveRDS(paste0("data/estban/preds_ml/preds/", tipo, "/preds_ranger_fcv.RDS"), compress = FALSE)
...
list(preds_glmnet, glmnet_time) |>
  saveRDS(paste0("data/estban/preds_ml/preds/", tipo, "/preds_glmnet_fcv.RDS"), compress = FALSE)
...
list(preds_lasso, lasso_time) |>
  saveRDS(paste0("data/estban/preds_ml/preds/", tipo, "/preds_lasso_fcv.RDS"), compress = FALSE)
...
list(preds_ridge, ridge_time) |>
  saveRDS(paste0("data/estban/preds_ml/preds/", tipo, "/preds_ridge_fcv.RDS"), compress = FALSE)
...
list(preds_svm, svm_time) |>
  saveRDS(paste0("data/estban/preds_ml/preds/", tipo, "/preds_svm_fcv.RDS"), compress = FALSE)
...
list(preds_lightgbm, lightgbm_time) |>
  saveRDS(paste0("data/estban/preds_ml/preds/", tipo, "/preds_lightgbm_fcv.RDS"), compress = FALSE)
