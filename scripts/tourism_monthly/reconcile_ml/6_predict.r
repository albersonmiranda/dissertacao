...
source("scripts/tourism_monthly/reconcile_ml/5_train_hp.R")
...
list(preds_xgb, xgb_time) |>
  saveRDS(paste0("data/tourism_monthly/preds_ml/preds/", tipo, "/preds_xgb.RDS"), compress = FALSE)
...
list(preds_ranger, ranger_time) |>
  saveRDS(paste0("data/tourism_monthly/preds_ml/preds/", tipo, "/preds_ranger.RDS"), compress = FALSE)
...
list(preds_glmnet, glmnet_time) |>
  saveRDS(paste0("data/tourism_monthly/preds_ml/preds/", tipo, "/preds_glmnet.RDS"), compress = FALSE)
...
list(preds_lasso, lasso_time) |>
  saveRDS(paste0("data/tourism_monthly/preds_ml/preds/", tipo, "/preds_lasso.RDS"), compress = FALSE)
...
list(preds_ridge, ridge_time) |>
  saveRDS(paste0("data/tourism_monthly/preds_ml/preds/", tipo, "/preds_ridge.RDS"), compress = FALSE)
...
list(preds_svm, svm_time) |>
  saveRDS(paste0("data/tourism_monthly/preds_ml/preds/", tipo, "/preds_svm.RDS"), compress = FALSE)
...
list(preds_nnet, nnet_time) |>
  saveRDS(paste0("data/tourism_monthly/preds_ml/preds/", tipo, "/preds_nnet.RDS"), compress = FALSE)
...
list(preds_lightgbm, lightgbm_time) |>
  saveRDS(paste0("data/tourism_monthly/preds_ml/preds/", tipo, "/preds_lightgbm.RDS"), compress = FALSE)
