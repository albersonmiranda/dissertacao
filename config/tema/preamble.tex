...
\usepackage{pdfpages}      % para inclusão de arquivos PDF (ficha catalográfica)
...
\setmonofont[Scale=0.9, Scale=MatchLowercase]{FiraCode Nerd Font}
...
\hypersetup{
    pagebackref=true,
	    ...
	    pdfcreator={LaTeX with abnTeX2},
		  pdfkeywords={Bancos}{Previsão}{Análise de séries temporais}{Aprendizado de máquinas}, 
