...
{\centering \includegraphics[width=1\textwidth,height=\textheight]{img/hierarq.png}

}

\caption{Séries Hierárquicas}
...
{\centering \includegraphics[width=1\textwidth,height=\textheight]{img/agrupadas.png}

}

\caption{Séries Agrupadas}
...
estrutura agrupada pode ocorrer tanto acima (Figure~\ref{fig-ha1})
quanto abaixo (Figure~\ref{fig-ha2}) da hierárquica.
